...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	protected float radiusInPixels;
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		pg.stroke(110);
		pg.fill(255,255,255);
		pg.rect(x, y - 21, pg.textWidth(title) +6, 18, 5);
	...
	private void colorDetermine(PGraphics pg) {
		...
		if (depth < THRESHOLD_MODERATE) { // light
			pg.fill(0, 200, 100, 200);
		}
		if (depth < THRESHOLD_INTERMEDIATE) { // moderate
			pg.fill(0, 100, 255, 200);
		}
		else if (depth < THRESHOLD_DEEP) { // intermediate
			pg.fill(150, 0, 255, 200);
		}
		else { // deep
			pg.fill(255, 0, 200);
		}
